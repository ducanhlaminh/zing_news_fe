...
export class CarouselComponent implements AfterViewInit, OnInit {
      ...
      books: any = [
            {
                  ...
                  new_article: {
                        ...
                        slug_crc: 2147483647,
                        content: 'Elizabeth Wraige nhớ lại lần đầu tiên bà đưa ra chẩn đoán về căn bệnh SMA cho một bệnh nhi. Bệnh nhân của bà được sinh ra trong niềm vui sướng khôn xiết của cha mẹ 6 tháng trước đó.\n\nTuy nhiên, họ bắt đầu cảm thấy có gì đó không ổn, khi cậu bé dường như k',
                        ...
                        avatar: 'https://znews-photo.zingcdn.me/w960/Uploaded/natmts/2023_05_04/z4319512309977_51bc7365424c81b45.jpg',
                        views: 0,
      ...
      getBooks() {
            this.NewsService.getNewArtclesCate(this.slug_crc).subscribe(
                  (data: any) => {
