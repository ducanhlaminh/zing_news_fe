...
export class CreatePostContentComponent {
  ...
  tinyMCEInit = {
    ...
    content_style:
      "@import url('https://fonts.googleapis.com/css2?family=Raleway&display=swap');@import url('https://fonts.googleapis.com/css2?family=Noto+Serif&display=swap');body {font-family: 'Berfilem'; margin: 0px 190px ;overflow-x: hidden;}",
  };
  onClick() {
